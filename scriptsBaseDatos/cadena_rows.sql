...
VALUES (1, 'Mercadona', 'Supermercado estándar', 'https://ejemplo.com/logos/mercadona.png'),
       ...
       (3, 'Carrefour Express', 'Tienda de conveniencia', 'https://ejemplo.com/logos/carrefour_express.png'),
       (4, 'Dia', 'Supermercado de descuento', 'https://ejemplo.com/logos/dia.png'),
       (5, 'Maskom', 'Supermercado regional', null),
       (9, 'Eroski', 'muy buena', '');