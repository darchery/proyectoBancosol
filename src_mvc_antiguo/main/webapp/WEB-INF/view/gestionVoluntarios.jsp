...
<body>
    ...
    <table border="1 px">
        ...
        <tr>
            ...
            <td><%= av.getTurnoActivoEntity().getTiendaCampanya().getTiendaEntity().getNombreEstablecimiento() %></td>

            <td>
                <%if (av.getTurnoActivoEntity().getTiendaCampanya().getTiendaEntity().getDireccionEntity() != null) {%>
                        <%= av.getTurnoActivoEntity().getTiendaCampanya().getTiendaEntity().getDireccionEntity().getZonaGeografica() %>
                <%}%>
            </td>
